...
function normalize(id: string, raw: unknown): UserRecord {
  ...
  return {
    ...
    searchEngine: asStr(o.searchEngine),
    searchQuery: asStr(o.searchQuery),
    utmSource: asStr(o.utmSource),
    utmMedium: asStr(o.utmMedium),
    utmCampaign: asStr(o.utmCampaign),
    landingPath: asStr(o.landingPath),
