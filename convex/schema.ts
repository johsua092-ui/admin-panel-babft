...
export default defineSchema({
  users: defineTable({
    ...
    vpnProvider: v.optional(v.union(v.string(), v.null())),
    asn: v.optional(v.union(v.string(), v.null())),
    asOrg: v.optional(v.union(v.string(), v.null())),
    mobile: v.optional(v.boolean()),
    referrer: v.optional(v.union(v.string(), v.null())),
    searchEngine: v.optional(v.union(v.string(), v.null())),
    ...
    landingPath: v.optional(v.union(v.string(), v.null())),
